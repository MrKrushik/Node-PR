...
module.exports.verifyEmail = async (req, res) => {
    try {
        ...
        if (!admin) {
            req.flash('error', 'No admin found with that email');
...
module.exports.OTPPage = (req, res) => {
    try {
        // require OTP to have been generated and kept in session
...
module.exports.OTPVerify = async (req, res) => {
    try {
        ...
        console.log("Developer Side : ", req.session);
        ...
        // clear OTP from session now that it's consumed
...
module.exports.newPasswordPage = (req, res) => {
    try {
        ...
        // OTP already removed in OTPVerify, but ensure it's gone
        delete req.session.OTP;
...
module.exports.editAdminPage = async (req, res) => {
    try {
        console.log("Editing admin with ID:", req.params.adminId);
        console.log("Current logged-in admin ID:", res.locals.admin.id);
        
        const singleAdmin = await Admin.findById(req.params.adminId);
        console.log("Found admin:", singleAdmin);
